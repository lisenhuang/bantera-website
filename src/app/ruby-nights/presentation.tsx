        ...
        {slide.id === 'pipeline' && <div className={`${s.featureSlide} ${s.pipelineSlide}`}>
          <div>
            ...
            <ol className={s.pipelineSteps}>
              <li><span>01</span><div><h2>Write the dialogue</h2><p>Gemini text creates the original script.</p></div></li>
              <li><span>02</span><div><h2>Generate the audio</h2><p>Gemini TTS gives the dialogue a voice.</p></div></li>
              <li><span>03</span><div><h2>Transcribe with timings</h2><p>Gemini hears each word and when it starts.</p></div></li>
              <li><span>04</span><div><h2>Match back to the script</h2><p>Exact matches first; Gemini resolves differences.</p></div></li>
            </ol>
